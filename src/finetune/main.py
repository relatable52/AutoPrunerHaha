...
def main():
    ...
    if(args.config_path == "config/kaggle_finetune_wala.config"):
        ...
        train_dataset1 =  Subset(train_dataset, range(0, len(train_dataset), 4))
        train_dataset2 = Subset(train_dataset, range(1, len(train_dataset), 4))
        train_dataset3 = Subset(train_dataset, range(2, len(train_dataset), 4))
        train_dataset4 = Subset(train_dataset, range(2, len(train_dataset), 4))
        print("Dataset 1: {} samples, dataset 2:{} samples, dataset 3:{} samples".format(len(train_dataset1), len(train_dataset2), len(train_dataset3)))
        train_loader1 = DataLoader(train_dataset1, **TRAIN_PARAMS)
        train_loader2 = DataLoader(train_dataset2, **TRAIN_PARAMS)
        train_loader3 = DataLoader(train_dataset2, **TRAIN_PARAMS)
        train_loader4 = DataLoader(train_dataset2, **TRAIN_PARAMS)
