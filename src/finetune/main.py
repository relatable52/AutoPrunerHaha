...
def main():
    ...
    if(args.config_path == "config/kaggle_finetune_wala.config"):
        ...
        train_dataset1 =  Subset(train_dataset, range(0, len(train_dataset), 3))
        train_dataset2 = Subset(train_dataset, range(1, len(train_dataset), 3))
        train_dataset3 = Subset(train_dataset, range(2, len(train_dataset), 3))
